    ...
    <section id="contact" style={{ padding: '5rem 0', backgroundColor: backgroundColor || 'transparent' }}>
      <div className="container">
        <div className="section-header">
          <div className="section-tag">STRATEGIC DISCOVERY & ONBOARDING</div>
          <h2 className="section-title" style={{ fontSize: '2.8rem', fontWeight: 900, fontFamily: 'Outfit, sans-serif' }}>
            Initiate Your Growth Partnership
          </h2>
          <p className="section-subtitle">
            Schedule an executive discovery consultation to audit your acquisition channels and build a custom growth roadmap.
          </p>
        </div>
