      ...
      <div className="container">
        ...
        <div className="section-header" style={{ textAlign: 'center', maxWidth: '850px', margin: '0 auto 4rem auto' }}>
          <div className="section-tag" style={{ letterSpacing: '0.1em' }}>
            GROWTH ARCHITECTURE — ABOUT DIGITAL DIGIX
          </div>
          <h2 style={{ fontSize: '3.2rem', fontWeight: 900, marginBottom: '1.25rem', lineHeight: 1.15, fontFamily: 'Outfit, sans-serif' }}>
            Precision Marketing Engineering <br />
            Built for Market Dominance.
          </h2>
          <p style={{ fontSize: '1.15rem', color: 'var(--text-muted)', lineHeight: 1.7, maxWidth: '740px', margin: '0 auto' }}>
            We bridge high-impact creative storytelling with rigorous performance algorithms, transparent pricing models, and real-time revenue analytics. Built on pure accountability and founder-led execution.
          </p>
        </div>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', flexGrow: 1 }}>
                ...
                <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', lineHeight: 1.5, margin: '0.2rem 0', minHeight: '3.4rem' }}>
                  Performance marketing architecture, brand positioning, and B2B growth strategy — scaling brands globally.
                </p>
                <div style={{ 
                  color: 'var(--primary)', 
                  fontWeight: 800, 
