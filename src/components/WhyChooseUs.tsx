      ...
      <section style={{ padding: '6rem 0', backgroundColor: backgroundColor || 'var(--bg-main)' }}>
        <div className="container">
          <div className="section-header">
            <div className="section-tag">THE DIGITAL DIGIX ADVANTAGE</div>
            <h2 style={{ fontSize: '2.8rem', fontWeight: 900, fontFamily: 'Outfit, sans-serif' }}>
              Data-Driven Precision. Engineered for Sustainable ROI.
            </h2>
            <p className="section-subtitle">
              We bridge creative ingenuity with advanced attribution modeling to generate predictable pipeline velocity and customer acquisition.
            </p>
          </div>
