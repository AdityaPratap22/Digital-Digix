...
export const FloatingSocials: React.FC = () => {
  const emailUrl = "mailto:contact.digitaldigix@gmail.com";
  ...
  return (
    <div className="floating-socials-container">
      ...
      <a
        href={emailUrl}
        className="floating-social-btn floating-social-btn--email"
        aria-label="Email Us"
        title="Email Us: contact.digitaldigix@gmail.com"
        style={{
          background: 'linear-gradient(135deg, #FF4E27 0%, #EA4335 100%)'
        }}
      >
        <svg 
          width="24" 
