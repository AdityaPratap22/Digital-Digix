  ...
  return (
    <div style={{ padding: '3rem 0 6rem 0' }}>
      <div className="container">
        ...
        <div className="section-header" style={{ textAlign: 'center', maxWidth: '850px', margin: '0 auto 2.5rem auto' }}>
          <h1 style={{ fontFamily: 'Outfit, serif', fontSize: '3.4rem', fontWeight: 900, marginBottom: '1rem', color: '#0F172A' }}>
            Services & Transparent Pricing
          </h1>
          <p style={{ fontSize: '1.15rem', color: 'var(--text-muted)', lineHeight: 1.6, margin: '0 auto' }}>
