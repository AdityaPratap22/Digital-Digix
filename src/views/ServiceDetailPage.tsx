...
const smmPackagesData = [
  {
    ...
    features: [
      ...
      '5-Day Turnaround Delivery',
      'Hashtag Research & Strategy',
      'Monthly PDF Analytics Report'
    ],
    whatsappText: 'Hi, I am interested in your Foundation SMM package ($750/mo)'
  },
  {
    name: 'Growth',
    price: '2,000',
    ...
    features: [
      ...
      '2 Revision Rounds Included',
      '3-Day Turnaround Delivery',
      'Custom SEO Caption Writing & Strategy',
      'Dedicated Account Management'
    ],
    whatsappText: 'Hi, I am interested in your Growth SMM package ($2,000/mo)'
  },
  {
    name: 'Premium',
    price: '4,000',
    ...
    features: [
      ...
      '16 Reels / Short-Form Videos + Motion Graphics',
      '3–4 Platforms (Full Ecosystem)',
      '2 Revision Rounds, Priority Handling',
      '48-Hour Turnaround Delivery',
      'Community DM & Comment Workflow',
      'Weekly Strategy & Growth Sync'
    ],
    whatsappText: 'Hi, I am interested in your Premium SMM package ($4,000/mo)'
  }
];

const webPackagesData = [
  {
    name: 'Foundation',
    price: '3,200',
    popular: false,
    ...
    features: [
      '5–8 Pages (Home, About, Services, Contact + 1–2 more)',
      'Custom Design Based on Brand',
      'Mobile Responsive & Fast Loading',
      'Basic SEO Setup & Meta Tags',
      'Contact Form & Lead Capture Included',
      '2 Revision Rounds Included',
      '1 Year Free SSL Cloud Hosting & Tech Support'
    ],
    whatsappText: 'Hi, I am interested in your Foundation Website package ($3,200)'
  },
  {
    name: 'Growth',
    price: '6,500',
    ...
    features: [
      '12–15 Pages, Custom UX Flows',
      'Deeper Custom UI/UX & Brand Design',
      'Third-Party Integrations & CRM Setup',
      'Basic Analytics + Speed Optimization (95+)',
      'WhatsApp Lead Chatbot & Booking Flow',
      '3 Revision Rounds Included',
      '1 Year Free SSL Cloud Hosting & Tech Support'
    ],
    whatsappText: 'Hi, I am interested in your Growth Website package ($6,500)'
  },
  {
    name: 'Premium',
    price: '14,000+',
    ...
    features: [
      '15+ Pages or Custom Web App Logic',
      'Dashboards, Client Portals & E-commerce',
      'Fully Custom UI/UX, Advanced Integrations',
      'Performance & Security Hardening',
      '3 Revision Rounds + Live Working Sessions',
      'Scoped After Discovery Call — Custom Quote',
      'Dedicated Tech Lead & 1 Year Support'
    ],
    whatsappText: 'Hi, I am interested in your Premium Website package ($14,000+)'
  }
];
...
const smmFaqsData = [
  ...
  { q: 'What is pay-as-you-go performance marketing?', a: 'If you prefer outcomes, we set up performance models where you pay per qualified lead generated, or purchase graphic assets individually (posters from $35, reels from $95, dashboards from $1,800).' },
...
export const ServiceDetailPage: React.FC<ServiceDetailPageProps> = ({ serviceId, onNavigate, onOpenStrategyModal }) => {
  ...
  const selectedService = detailed17Services.find(s => 
    s.id === serviceId || 
    s.title.toLowerCase().replace(/[^a-z0-9]/g, '-') === serviceId ||
    (serviceId === '4' && s.id === 'dashboard-kpi-systems') ||
    (serviceId === '5' && s.id === 'seo-services') ||
    (serviceId === '8' && s.id === 'website-development') ||
    (serviceId === '1' && s.id === 'social-media-marketing') ||
    (serviceId === '2' && s.id === 'graphic-design')
  );
  ...
  const isWeb = selectedService.title === 'Website Development';
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap', borderTop: '1px solid #F1F5F9', paddingTop: '2rem' }}>
            ...
            <div style={{ marginLeft: 'auto', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <a
                href={`https://wa.me/918586989832?text=Hi%2C%20I%20am%20interested%20in%20your%20${encodeURIComponent(selectedService.title)}%20services`}
                target="_blank"
        ...
        {isSmm ? (
          <div>
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ fontSize: '1.05rem', color: '#64748B' }}>
                Monthly retainers scale content volume, platform coverage, and turnaround speed.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: '1rem', color: '#475569', lineHeight: 1.6, margin: 0 }}>
                Prefer outcomes over retainers? Our pay-per-performance model lets you pay only for leads that meet criteria agreed upfront — budget, location and intent. Single deliverables start tiny: posters from $35, reels from $95, dashboards from $1,800. <a href="https://wa.me/918586989832?text=Hi%2C%20I%20am%20interested%20in%20your%20services" target="_blank" rel="noopener noreferrer" style={{ color: '#3B82F6', fontWeight: 800, textDecoration: 'underline' }}>Request a quote</a> and we'll build a plan around your numbers.
              </p>
            </div>
          ...
          <div>
            ...
            <h3 style={{ fontFamily: 'Outfit, serif', fontSize: '2.2rem', fontWeight: 900, color: '#0F172A', textAlign: 'center', marginBottom: '0.5rem' }}>
              Graphic Design Packages & Bundles
            </h3>
            <p style={{ fontSize: '0.95rem', color: '#64748B', textAlign: 'center', marginBottom: '2.5rem', maxWidth: '650px', margin: '0 auto 2.5rem auto', lineHeight: 1.5 }}>
              Transparent bundle pricing across formats. No hidden fees.
            </p>
                    ...
                    {cat.items.map((item, itemIdx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {item.price && <span style={{ fontWeight: 700, color: '#3B82F6', whiteSpace: 'nowrap', flexShrink: 0, textAlign: 'right' }}>{item.price}</span>}
                        </div>
                      );
                    })}
                  </div>
          ...
          <div>
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              <div style={{ fontSize: '0.75rem', fontWeight: 800, color: '#3B82F6', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>
                — WEB ENGINEERING PACKAGES —
              </div>
              <h2 style={{ fontFamily: 'Outfit, serif', fontSize: '2.5rem', fontWeight: 900, color: '#0F172A', marginBottom: '0.75rem' }}>
                Website Creation Packages
              </h2>
              <p style={{ fontSize: '1.05rem', color: '#64748B', maxWidth: '700px', margin: '0 auto' }}>
                All tiers include mobile-responsive builds; higher tiers add deeper customization, third-party integrations, and performance/security hardening.
              </p>
            </div>

            {/* Web Packages Grid */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem', marginBottom: '4rem', alignItems: 'stretch' }} className="graphics-pricing-grid">
              {webPackagesData.map((pkg, idx) => (
                <div
                  key={idx}
                  style={{
                    backgroundColor: pkg.popular ? '#1A1311' : '#FFFFFF',
                    ...
                    display: 'flex',
                    flexDirection: 'column',
                    boxShadow: pkg.popular ? '0 15px 35px rgba(59, 130, 246, 0.15)' : '0 10px 30px rgba(0, 0, 0, 0.02)',
                    position: 'relative'
                  }}
                >
                  {pkg.badge && (
                  ...
                  <div style={{ marginBottom: '1.25rem' }}>
                    <span style={{ fontSize: '0.8rem', fontWeight: 800, color: pkg.popular ? '#60A5FA' : '#3B82F6', textTransform: 'uppercase', letterSpacing: '0.12em' }}>
                      {pkg.name}
                    </span>
                    <div style={{ display: 'flex', alignItems: 'baseline', marginTop: '0.4rem' }}>
                      <span style={{ fontSize: '2.5rem', fontWeight: 900, fontFamily: 'Outfit, serif' }}>
                    ...
                    <div style={{ fontSize: '0.85rem', color: pkg.popular ? '#94A3B8' : '#64748B', fontWeight: 600, marginTop: '0.25rem' }}>
                      ⏱ {pkg.timeline}
                    </div>
                  </div>
                  ...
                  <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.7rem', listStyle: 'none', padding: 0, margin: '0 0 1.75rem 0', flex: 1, fontSize: '0.95rem' }}>
                    {pkg.features.map((feature, fIdx) => (
                      <li key={fIdx} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem' }}>
                        <span style={{ color: pkg.popular ? '#60A5FA' : '#3B82F6', fontWeight: 900, marginTop: '0.1rem' }}>✓</span>
                        <span style={{ color: pkg.popular ? '#E2E8F0' : '#475569', fontWeight: 500 }}>{feature}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  <a
                    ...
                    style={{
                      ...
                      fontSize: '0.95rem',
                      textDecoration: 'none',
                      backgroundColor: pkg.popular ? '#3B82F6' : '#1A1311',
                      color: '#FFFFFF',
                      border: 'none',
                      cursor: 'pointer'
                    }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem', marginBottom: '4rem' }} className="graphics-info-blocks">
              <div style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', borderRadius: '20px', padding: '1.75rem 2rem', boxShadow: '0 4px 12px rgba(0,0,0,0.02)' }}>
                ...
                <p style={{ fontSize: '0.9rem', color: '#475569', lineHeight: 1.6, margin: 0 }}>
                  We build lightning-fast, high-converting digital flagships using Next.js and modern CMS frameworks. From custom brand design to WhatsApp instant lead integration and Core Web Vitals optimization, every build is scoped for measurable revenue growth.
                </p>
              </div>
              <div style={{ background: '#0F172A', borderRadius: '20px', padding: '1.75rem 2rem', color: '#FFF' }}>
                ...
                <p style={{ fontSize: '0.9rem', color: '#94A3B8', lineHeight: 1.6, margin: 0 }}>
                  Clients experience 95+ Google PageSpeed scores, sub-second load times, and a 2.5x to 4x increase in inbound form submissions and direct WhatsApp consultation inquiries.
                </p>
              </div>
            </div>
          </div>
