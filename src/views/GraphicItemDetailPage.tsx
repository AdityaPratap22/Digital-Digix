...
export const GraphicItemDetailPage: React.FC<GraphicItemDetailPageProps> = ({ itemId, onNavigate, onOpenStrategyModal }) => {
  ...
  const customData = customExplanations[itemId] || {
    ...
    turnaround: matchedCategory.title.includes('Multi-Page') ? '3–5 Days' : '48 Hours',
        ...
        <div style={{ 
          ...
          <div style={{ maxWidth: '960px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <div style={{ fontSize: '0.75rem', color: '#64748B', fontWeight: 800, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Pricing</div>
                <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: '1.4rem', fontWeight: 900, color: '#D97706', marginTop: '0.2rem' }}>
                  {matchedItem.price || (matchedCategory.title.includes('—') ? matchedCategory.title.split('—')[1].trim() : 'Custom Quote')}
                </div>
              </div>
            </div>
