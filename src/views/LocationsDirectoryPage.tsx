    ...
    <div style={{ backgroundColor: '#FDFBF7', minHeight: '100vh', padding: '2rem 0 6rem 0' }}>
      <div className="container" style={{ maxWidth: '1180px' }}>
        ...
        <div style={{ fontSize: '0.875rem', color: '#64748B', marginBottom: '1.5rem' }}>
          <span style={{ cursor: 'pointer', color: '#3B82F6' }} onClick={() => onNavigate('home')}>Home</span> / <span style={{ color: '#0F172A', fontWeight: 700 }}>Global Locations Directory</span>
        </div>
        ...
        <div className="responsive-hero-card" style={{ background: '#FFFFFF', borderTop: '4px solid #FF4E27', borderLeft: '1px solid #E2E8F0', borderRight: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0', borderRadius: '24px', padding: '3.5rem 3rem', marginBottom: '3rem', boxShadow: '0 15px 35px rgba(11,19,42,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <span style={{ fontSize: '0.75rem', fontWeight: 800, color: '#FF4E27', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
              INTERNATIONAL GEOGRAPHIC COVERAGE ({ALL_COUNTRY_LOCATIONS.length} COUNTRIES & TERRITORIES · {totalCitiesCount}+ CITIES)
            </span>
          </div>

          <h1 style={{ fontFamily: 'Outfit, serif', fontSize: '3.2rem', fontWeight: 900, color: '#0F172A', lineHeight: 1.15, marginBottom: '1.25rem' }}>
            Global Digital Marketing & Performance Directory
          </h1>

          <p style={{ fontSize: '1.1rem', color: '#475569', lineHeight: 1.7, maxWidth: '850px', marginBottom: '2.25rem' }}>
            Digital Digix delivers high-ROI performance marketing, Local SEO & Google Maps optimization, Google & Meta PPC ads, high-converting social media management, and bespoke web engineering across high-value international economies, Western & Northern Europe, the Middle East & Gulf, North America, the Caribbean, and global business hubs.
          </p>
          ...
          <div style={{ background: '#F8FAFC', padding: '1.5rem', borderRadius: '20px', border: '1px solid #E2E8F0', display: 'flex', flexWrap: 'wrap', gap: '1.25rem', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ position: 'relative', width: '100%', maxWidth: '480px' }}>
              <input
                type="text"
                placeholder="🔍 Search country, capital or city (e.g. United Kingdom, Zurich, Munich, Kuwait)..."
                value={searchQuery}
        ...
        {/* 3. PRIORITY GLOBAL MARKETS QUICK SELECT */}
        {activeTab === 'All' && !searchQuery && (
          <div style={{ marginBottom: '3rem', backgroundColor: '#FFFFFF', padding: '2rem 2.25rem', borderRadius: '24px', border: '1px solid #BAE6FD', boxShadow: '0 8px 25px rgba(0,0,0,0.03)' }}>
            <h2 style={{ fontFamily: 'Outfit, serif', fontSize: '1.5rem', fontWeight: 900, color: '#0284C7', marginBottom: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ⭐ Priority High-Growth Global Markets
            </h2>
        ...
        {/* 4. COUNTRY-BY-COUNTRY GLOBAL DIRECTORY GRID */}
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem', paddingBottom: '1rem', borderBottom: '1px solid #F1F5F9', flexWrap: 'wrap', gap: '1rem' }}>
                  <div>
                    <h2
                      ...
                      style={{ fontFamily: 'Outfit, serif', fontSize: '1.75rem', fontWeight: 900, color: '#0F172A', margin: '0 0 0.25rem 0', display: 'flex', alignItems: 'center', gap: '0.6rem', cursor: 'pointer' }}
                      onMouseEnter={(e) => e.currentTarget.style.color = '#FF4E27'}
                      onMouseLeave={(e) => e.currentTarget.style.color = '#0F172A'}
                    >
                      <span style={{ fontSize: '1.5rem' }}>📍</span>
                      <span>{countryData.country}</span>
                      <span style={{ fontSize: '0.85rem', color: '#3B82F6', fontWeight: 700 }}>View Full Country Page →</span>
                    </h2>
                    <div style={{ fontSize: '0.85rem', color: '#64748B', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                      <span>🏛️ Capital: <strong>{countryData.capital}</strong></span>
                      <span>💱 Currency: <strong>{countryData.currency}</strong></span>
                      <span>🌍 Region: <strong>{countryData.region}</strong></span>
                    </div>
                  </div>
                  ...
                  <span style={{ fontSize: '0.825rem', fontWeight: 800, color: '#FF4E27', backgroundColor: '#FFF0ED', padding: '0.35rem 0.9rem', borderRadius: '999px' }}>
                    {countryData.majorCities.length + countryData.regionalCities.length} Markets Listed
                  </span>
                </div>

                {/* MAJOR COMMERCIAL METROS */}
                {majorList.length > 0 && (
                  <div style={{ marginBottom: '1.5rem' }}>
                    <div style={{ fontSize: '0.8rem', fontWeight: 800, color: '#3B82F6', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.85rem' }}>
                      PRIMARY METROS & COMMERCIAL HUBS
                    </div>
                ...
                {regionalList.length > 0 && (
                  <div>
                    <div style={{ fontSize: '0.8rem', fontWeight: 800, color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.85rem' }}>
                      REGIONAL CITIES, DISTRICTS & RESORT HUBS
                    </div>
      ...
      <div className="container" style={{ maxWidth: '1100px' }}>
        <div style={{ background: '#181311', borderRadius: '24px', padding: '3.5rem 2rem', textAlign: 'center', color: '#FFFFFF', boxShadow: '0 20px 40px rgba(0,0,0,0.2)' }}>
          ...
          <p style={{ fontSize: '1rem', color: '#94A3B8', marginBottom: '2rem' }}>
            We provide full-spectrum digital marketing, SEO, performance advertising, and bespoke web solutions for businesses in any location worldwide.
          </p>
